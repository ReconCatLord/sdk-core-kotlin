...
class XyoBoundWitnessUtilTest : XyoTestBase() {
    ...
    @Test
    fun swiftHelper () {
        val objects = XyoIterableObject.createUntypedIterableObject(XyoSchemas.ARRAY_UNTYPED, arrayOf(XyoIterableObject.createUntypedIterableObject(XyoSchemas.ARRAY_UNTYPED, arrayOf(XyoBuff.newInstance(XyoSchemas.RSSI, byteArrayOf(0x00)), XyoBuff.newInstance(XyoSchemas.RSSI, byteArrayOf(0x00)) , XyoBuff.newInstance(XyoSchemas.RSSI, byteArrayOf(0x00))))))
        println(objects.bytesCopy.toHexString())
    }
    ...
    fun testRemoveTypeFromWitnesses () {
        ...
        for (witness in removedBoundWitness[XyoSchemas.WITNESS.id]) {
